...
// from http://paulbourke.net/geometry/circlecircle/raycircle.c

const EPSILON = 1e-8;

const dp = [0, 0];

// Calculate the intersection of an infinite ray and a circle
...
export default function rayCircleOverlap(p1, p2, sc, r, contact) {
