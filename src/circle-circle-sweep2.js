...
/*
const SCALAR ra, //radius of circle A
const VECTOR& A0, //previous position of circle A
const VECTOR& A1, //current position of circle A
const SCALAR rb, //radius of circle B
const VECTOR& B0, //previous position of circle B
const VECTOR& B1, //current position of circle B
SCALAR& u0, //normalized time of first collision
SCALAR& u1 //normalized time of second collision
*/
export default function circleCircleSweep2(ra, A0, A1, rb, B0, B1, contact) {
