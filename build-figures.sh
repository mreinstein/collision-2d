...
deno run --allow-read --allow-write --allow-run --allow-net --allow-import cli-figure-to-apng.ts --module figures/tri-point-overlap.js --count 1200 --output docs/tri-point-overlap.png
